...
public static class Ferr2D_Triangulator
{
	...
	public  static List<int> GetIndices           (ref List<Vector2> aPoints, bool aTreatAsPath, bool aInvert, float aVertGridSpacing = 0, float topHeight = 1, float bottomHeight = 1, float leftWidth = 1, float rightWidth = 1) {
		...
		Polygon poly;
		if (aInvert) {
			aPoints.Add(new Vector2(bounds.x - leftWidth/*(bounds.z - bounds.x)*/ * 1, bounds.w - bottomHeight/*(bounds.y - bounds.w)*/ * 1)); // 4
			aPoints.Add(new Vector2(bounds.z + rightWidth/*(bounds.z - bounds.x)*/ * 1, bounds.w - bottomHeight/*(bounds.y - bounds.w)*/ * 1)); // 3
			aPoints.Add(new Vector2(bounds.z + rightWidth/*(bounds.z - bounds.x)*/ * 1, bounds.y + topHeight/*(bounds.y - bounds.w)*/ * 1)); // 2
			aPoints.Add(new Vector2(bounds.x - leftWidth/*(bounds.z - bounds.x)*/ * 1, bounds.y + topHeight/*(bounds.y - bounds.w)*/ * 1)); // 1
