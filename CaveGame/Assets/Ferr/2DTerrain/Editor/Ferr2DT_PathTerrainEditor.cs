...
public class Ferr2DT_PathTerrainEditor : Editor {
    ...
    //Experimental by Jared
    SerializedProperty topBorderHeight;
    SerializedProperty bottomBorderHeight;
    SerializedProperty leftBorderWidth;
    SerializedProperty rightBorderWidth;
    //
	...
	private void LoadProperties() {
        ...
        //Experimental by Jared
        topBorderHeight          = serializedObject.FindProperty("topBorderHeight");
        bottomBorderHeight       = serializedObject.FindProperty("bottomBorderHeight");
        leftBorderWidth          = serializedObject.FindProperty("leftBorderWidth");
        rightBorderWidth         = serializedObject.FindProperty("rightBorderWidth");
        //
	...
	public override void OnInspectorGUI() {
        ...
        if (showTerrainType) {
	        ...
	        Ferr.EditorTools.Box(4, ()=>{
                ...
                //Experimental by Jared!
                if (fill.enumValueIndex == (int)Ferr2DT_FillMode.InvertedClosed) EditorGUILayout.PropertyField(topBorderHeight, new GUIContent("Top Border Height"));
                if (fill.enumValueIndex == (int)Ferr2DT_FillMode.InvertedClosed) EditorGUILayout.PropertyField(bottomBorderHeight, new GUIContent("Bottom Border Height"));
                if (fill.enumValueIndex == (int)Ferr2DT_FillMode.InvertedClosed) EditorGUILayout.PropertyField(leftBorderWidth, new GUIContent("Left Border Width"));
                if (fill.enumValueIndex == (int)Ferr2DT_FillMode.InvertedClosed) EditorGUILayout.PropertyField(rightBorderWidth, new GUIContent("Right Border Width"));
                //
