...
public class Ferr2DT_PathTerrain : MonoBehaviour, Ferr2D_IPath {
    ...
    public float topBorderHeight = 5;
    public float bottomBorderHeight = 5;
    public float leftBorderWidth = 5;
    public float rightBorderWidth = 5;
    //
	...
	private void AddFill   (bool aSkirt, bool aFullBuild) {
		...
		List<int> indices = Ferr2D_Triangulator.GetIndices(ref fillVerts, true, fill == Ferr2DT_FillMode.InvertedClosed, fillSplit && aFullBuild ? fillSplitDistance : 0, fill == Ferr2DT_FillMode.InvertedClosed ? topBorderHeight : 1, fill == Ferr2DT_FillMode.InvertedClosed ? bottomBorderHeight : 1, fill == Ferr2DT_FillMode.InvertedClosed ? leftBorderWidth : 1, fill == Ferr2DT_FillMode.InvertedClosed ? rightBorderWidth : 1);
